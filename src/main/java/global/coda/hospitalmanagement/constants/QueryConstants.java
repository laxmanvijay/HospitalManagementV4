...
public final class QueryConstants {
	...
	public static final String READ_DOCTOR_BY_ID_QUERY = "<script> select * from t_user join t_doctor on t_user.pk_user_id=t_doctor.fk_user_id where <if test = 'id!=0'> fk_user_id=#{id} and </if> is_active=1 </script>";
